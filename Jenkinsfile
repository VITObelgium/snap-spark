...
void deploy(hdfs_dir="/workflows/snap/",rel_version){
    ...
    dir("snap-gpt-spark/auxdata") {
        ...
        sh "mkdir -p openjpeg/8.0.2/openjpeg-2.1.0-linux64/bin"
        sh "curl -o openjpeg/8.0.2/openjpeg-2.1.0-linux64/bin/libopenjp2.so https://raw.githubusercontent.com/senbox-org/snap-engine/8.0.2/lib-openjpeg/src/main/resources/auxdata/openjpeg/openjpeg-2.1.0-linux64/bin/libopenjp2.so"
        sh "curl -o openjpeg/8.0.2/openjpeg-2.1.0-linux64/bin/opj_compress https://raw.githubusercontent.com/senbox-org/snap-engine/8.0.2/lib-openjpeg/src/main/resources/auxdata/openjpeg/openjpeg-2.1.0-linux64/bin/opj_compress"
        sh "curl -o openjpeg/8.0.2/openjpeg-2.1.0-linux64/bin/opj_decompress https://raw.githubusercontent.com/senbox-org/snap-engine/8.0.2/lib-openjpeg/src/main/resources/auxdata/openjpeg/openjpeg-2.1.0-linux64/bin/opj_decompress"
        sh "curl -o openjpeg/8.0.2/openjpeg-2.1.0-linux64/bin/opj_dump https://raw.githubusercontent.com/senbox-org/snap-engine/8.0.2/lib-openjpeg/src/main/resources/auxdata/openjpeg/openjpeg-2.1.0-linux64/bin/opj_dump"
