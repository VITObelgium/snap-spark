...
void deploy(hdfs_dir="/workflows/snap/",rel_version){
    ...
    dir("snap-gpt-spark/auxdata") {
        ...
        sh "curl -o openjpeg/8.0.2/libopenjp2.so https://raw.githubusercontent.com/senbox-org/snap-engine/raw/8.0.2/lib-openjpeg/src/main/resources/auxdata/openjpeg/openjpeg-2.1.0-linux64/bin/libopenjp2.so"
        sh "curl -o openjpeg/8.0.2/opj_compress https://raw.githubusercontent.com/senbox-org/snap-engine/raw/8.0.2/lib-openjpeg/src/main/resources/auxdata/openjpeg/openjpeg-2.1.0-linux64/bin/opj_compress"
        sh "curl -o openjpeg/8.0.2/opj_decompress https://raw.githubusercontent.com/senbox-org/snap-engine/raw/8.0.2/lib-openjpeg/src/main/resources/auxdata/openjpeg/openjpeg-2.1.0-linux64/bin/opj_decompress"
